...
echo #########################################################################
echo #                                                                       #
echo #            Welcome to Section Z easy DayZ installler v2.2.            #
...
echo 2 - Install ArmA 2 Beta Patch 106400
...
if exist Expansion\beta\arma2oa.exe (
	...
	echo.
	echo Installing ARMA2_OA_Build_106400...
	dayz_install\ARMA2_OA_Build_106400.exe
)
cls
goto menu
