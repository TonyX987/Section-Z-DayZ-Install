...
:start
echo Section Z Game Launcher v3.2 created by CE28N.
...
:start_chernarus
cls
if exist @DayZ\addons\dayz.pbo (start Expansion\beta\arma2oa.exe -mod=@Dayz;CA;Expansion\beta;Expansion\beta\Expansion -noFilePatching -nosplash -noPause -world=Chernarus -cpuCount=4 -exThreads=1 -maxmem=2047 -noCB) else (goto dayz_checkfail)
exit

:start_namalsk
cls
if exist @DayZ_Namalsk\addons\namalsk.pbo (start Expansion\beta\arma2oa.exe -mod=@DayZ_Namalsk_@DayZ;@DayZ_Namalsk;Expansion\beta;Expansion\beta\Expansion -noFilePatching -nosplash -noPause -cpuCount=4 -exThreads=1 -maxmem=2047 -noCB) else (goto dayz_checkfail)
exit

:start_taviana
cls
if exist @Taviana\addons\dayz.pbo (start Expansion\beta\arma2oa.exe -mod=@Taviana;Expansion\beta;Expansion\beta\Expansion -noFilePatching -nosplash -noPause -cpuCount=4 -exThreads=1 -maxmem=2047 -noCB) else (goto dayz_checkfail)
exit

:start_origins
cls
if exist @DayzOrigins\addons\dayz.pbo (start Expansion\beta\arma2oa.exe -mod=@DayzOrigins;Expansion\beta;Expansion\beta\Expansion -noFilePatching -nosplash -noPause -cpuCount=4 -exThreads=1 -maxmem=2047 -noCB) else (goto dayz_checkfail)
exit
